...
function setupMetamask(browser, options = defaultMetamaskOptions) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const dappetteer = yield metamask_1.getMetamask(page);
        yield closeNotificationPage(browser, dappetteer);
        return dappetteer;
    });
}
...
function closeNotificationPage(browser, dappetteer) {
    return __awaiter(this, void 0, void 0, function* () {
            ...
            if (target.url().match('chrome-extension://[a-z]+/notification.html')) {
                try {
                    if (dappetteer.confirmResolve) {
                        const confirmPage = yield target.page();
